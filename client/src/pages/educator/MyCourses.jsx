  ...
  return courses ? (
    <div className="h-screen flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <div className='w-full'>
        ...
        <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-card border border-forge-border shadow-card">
          <table className="md:table-auto table-fixed w-full overflow-hidden">
            <thead className="bg-forge-mist text-xs font-semibold text-forge-muted uppercase tracking-wide border-b border-gray-500/20 text-left">
              <tr>
            ...
            <tbody className="text-sm text-gray-500">
              {courses.map((course) => (
                <tr key={course._id} className="border-b border-gray-500/20 hover:bg-forge-mist/50 transition-colors duration-100">
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="p-2 hover:text-forge-danger hover:bg-red-50 rounded-md transition-all duration-150"
                      title="Remove course"
                    >
