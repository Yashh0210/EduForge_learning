    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div>
          ...
          <div className="flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer border-2 border-dashed border-forge-border hover:border-forge-signal hover:text-forge-signal transition-all duration-200" onClick={() => handleChapter('add')}>
            + Add Chapter
          </div>
        ...
        <button type="submit" className='bg-forge-signal text-white font-semibold px-8 py-3 rounded-btn hover:bg-indigo-700 transition-colors duration-150 text-sm w-max my-4'>
          Publish course
        </button>
      </form>
    </div>
